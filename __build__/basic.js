...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libIndex = __webpack_require__(158);
	...
	var App = _react2['default'].createClass({
	  ...
	  render: function render() {
	    var images = [{ src: 'http://imgsv.imaging.nikon.com/lineup/lens/zoom/normalzoom/af-s_dx_18-300mmf_35-56g_ed_vr/img/sample/sample4_l.jpg', href: 'https://google.com' }, { src: 'http://www.ricoh-imaging.co.jp/english/r_dc/caplio/r7/img/sample_04.jpg' }, { src: 'http://images.fonearena.com/blog/wp-content/uploads/2013/11/Lenovo-p780-camera-sample-10.jpg' }, { src: 'http://imaging.nikon.com/lineup/lens/zoom/normalzoom/af-s_dx_18-300mmf_35-56g_ed_vr/img/sample/sample1_l.jpg' }, { src: 'http://images.fonearena.com/blog/wp-content/uploads/2013/11/Lenovo-p780-camera-sample-10.jpg' }, { src: 'http://imaging.nikon.com/lineup/lens/zoom/normalzoom/af-s_dx_18-300mmf_35-56g_ed_vr/img/sample/sample1_l.jpg' }, { src: 'http://www.forkingandcountry.com/sites/g/files/g2000004371/f/sample_01.jpg' }, { src: 'http://imaging.nikon.com/lineup/lens/zoom/normalzoom/af-s_24-85mmf_35-45g_ed_vr/img/sample/sample2_l.jpg' }, { src: 'http://www.cameraegg.org/wp-content/uploads/2013/03/Canon-EOS-100D-Rebel-SL1-Sample-Image.jpg' }, { src: 'http://www.forkingandcountry.com/sites/g/files/g2000004371/f/sample_01.jpg' }, { src: 'http://imaging.nikon.com/lineup/lens/zoom/normalzoom/af-s_24-85mmf_35-45g_ed_vr/img/sample/sample2_l.jpg' }, { src: 'http://www.cameraegg.org/wp-content/uploads/2013/03/Canon-EOS-100D-Rebel-SL1-Sample-Image.jpg' }, { src: 'http://imgsv.imaging.nikon.com/lineup/lens/zoom/normalzoom/af-s_dx_18-300mmf_35-56g_ed_vr/img/sample/sample4_l.jpg' }, { src: 'http://www.ricoh-imaging.co.jp/english/r_dc/caplio/r7/img/sample_04.jpg' }];
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(_libIndex2['default'], { images: images, columns: 5, useLightbox: true })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsImgGallery = __webpack_require__(159);

	var _componentsImgGallery2 = _interopRequireDefault(_componentsImgGallery);

	exports['default'] = _componentsImgGallery2['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Lightbox = _react2['default'].createClass({
	  ...
	  render: function render() {
	    return _react2['default'].DOM.div({ id: 'lg-img' }, _react2['default'].DOM.img({ src: this.props.src }, null));
	  }
	});
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  propTypes: {
	    ...
	    useLightbox: _react2['default'].PropTypes.bool
	  },
	  ...
	  displayLightbox: function displayLightbox(imageSrc) {
	    if (imageSrc) {
	  ...
	  render: function render() {
	    ...
	    this.props.images.forEach(function (image, index) {
	      images.push(_this.props.useLightbox ? _react2['default'].DOM.img({ key: index, src: image.src, onClick: _this.displayLightbox.bind(null, image.src),
	        style: { cursor: 'pointer' } }, null) : _react2['default'].DOM.a({ key: index, href: image.href }, _react2['default'].DOM.img({ key: index, src: image.src }, null)));
	    });

	    return _react2['default'].DOM.div({}, _react2['default'].DOM.div({ id: this.props.id, className: 'img-gallery ' + this.props['class'] }, images), _react2['default'].DOM.div({}, this.state.activeImage ? _react2['default'].DOM.div({ id: 'img-lightbox', onClick: this.displayLightbox.bind(null, false) }, _react2['default'].createElement(Lightbox, { src: this.state.activeImage.src })) : null));
	  }
	});
	module.exports = exports['default'];
